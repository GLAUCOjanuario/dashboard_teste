...
//   const totalPaidInvoices = latestInvoices.filter((invoice: any) => invoice.status === 'paid').reduce((sum: number, invoice: any) => sum + invoice.amount, 0);
//   const totalPendingInvoices = latestInvoices.filter((invoice: any) => invoice.status === 'pending').reduce((sum: number, invoice: any) => sum + invoice.amount, 0);
